...
export const Home: Component = () => {
  return(<Default class={"page home"}>
    ...
    <div id="event" class="wrap" style="margin-bottom: 128px;">
      ...
      <p>
        Op 9 Mei 2025 zal GoedGestemd de eerste Get-Together organiseren waarbij mensen vrij binnen kunnen lopen zonder aanmelding of entree.
      </p>
      <iframe 
        ...
        width="100%" 
        height="450" 
        style="border:0; border-radius: 16px; box-shadow: 0px 0px 16px 0px rgba(0,0,0,0.1);"
        allowfullscreen="" 
        loading="lazy" 
